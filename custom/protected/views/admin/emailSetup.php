...
<div class="admin-form-container">
    <div class="form">
        <p><?php echo Yii::t('admin','For more information, see {config} on the wiki.',array('{config}'=>CHtml::link(Yii::t('admin','Email Configuration'),'http://wiki.x2engine.com/wiki/E-Mail_Configuration'))); ?></p>
        <hr />
        <?php
        ...
        <p><?php echo Yii::t('admin', 'Configure how Upward Plus+ sends email when mailing en-masse.'); ?></p>
        <div class="row">
            <div class="cell">
    ...
    <p><?php echo Yii::t('admin', 'Configure how Upward Plus+ sends email when responding to new service case requests.'); ?></p>
    <div class="row">
        <div class="cell">
    ...
    ?>
        ...
        ?> 
        <h4><?php echo Yii::t('admin', 'Workflow Email Settings'); ?></h4>
        <br/>
        <div class="row">
            <div class="cell">
                <?php
                ...
                echo X2Html::hint (
                    Yii::t('admin', 'If checked, emails will not be sent from Workflow to contacts '.
