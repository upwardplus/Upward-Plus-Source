...
class ProfileController extends x2base {
    ...
    public function insertActionMenu () {
        ...
        $this->actionMenu = array(
			...
			array(
                'name' => 'profiles', 
                'label' => Yii::t('profile', 'View All Profiles'), 
                'url' => array('profiles'),
				'visible' => $isAdmin
            ),
            ...
            array(
                'name' => 'viewPublic', 
                'label' => Yii::t('profile', 'View My Profile'), 
                'url' => array('view', 'id' => $model->id, 'publicProfile' => 1)
            ),
            array(
                'name' => 'edit', 
                'label' => Yii::t('profile', 'Edit My Profile'),
                'url' => array('update', 'id' => $model->id)
            ),
            array(
                'name' => 'settings', 
                'label' => Yii::t('profile', 'Settings'), 
                'url' => array('settings', 'id' => $model->id),
				'visible' => ($model->id == Yii::app()->user->id)
            ),
            array(
                'name' => 'changePassword', 
                'label' => Yii::t('profile', 'Change My Password'), 
                'url' => array('changePassword', 'id' => $model->id), 'visible' => ($model->id == Yii::app()->user->id)
            )
            /*
			*****  REMOVED PERMANENTLY: This is accessed on the profile dropdown for admins  *****
			array(
