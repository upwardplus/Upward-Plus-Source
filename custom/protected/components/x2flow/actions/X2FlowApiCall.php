        ...
        if ($staticValidation && 
            ...
            return array (
                ...
                Yii::t(
                    ...
                    'same server that Upward Plus+ is hosted on. This could mean that this flow makes '.
                    'a request to the Upward Plus+ API. Calling the Upward Plus+ API from a Workflow is not '.
        ...
        if($this->parseOption('immediate', $params) || true){
            ...
            if (!$this->validateUrl ($url)) {
                if (YII_UNIT_TESTING) {
                    ...
                    return array(
                        false, 
                        Yii::t('studio', 'Requests cannot be made to the Upward Plus+ API from a Workflow.')
                    );
                }
            }
