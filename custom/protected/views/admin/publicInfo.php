...
<div class="admin-form-container">
    ...
    <div class="form">
        ...
        echo Yii::t('admin','If you want to track contacts on a website with a domain that is '.
            'different from the domain on which this app is hosted, you\'ll have to set this to your '.
...
?>
        ...
        echo Yii::t('admin', 'should use this if the CRM is behind a firewall and you access Upward Plus+ using a different URL than one would use to access it from the internet (i.e. a host name / IP address on a private subnet or VPN).'); 
        ?></p>
