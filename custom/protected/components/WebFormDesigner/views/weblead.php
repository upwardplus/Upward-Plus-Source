...
<!--  -->
<div class='webform-tab' id='info-tab' data-title='<?php echo Yii::t('marketing','Form Information'); ?>'>
    <div class='tab-content'>
        <div class="cell">
			<h4>Form Information</h4>
			<p id="formid-text" style="width: 600px;">The codes below will allow you to use this form with your own HTML or landing pages.
			<a href="https://upwardplus.com/comingsoon" target="_blank">Learn More</a></p>
			<div id="code-output-1">Form ID:<input id="webformid" readonly type='text'/></div>
			<div id="code-output-2">Form Token:<p id="webformtoken"></p></div>
			<script>
				var x = document.getElementsByName("YII_CSRF_TOKEN")[0].value;
				document.getElementById("webformtoken").innerHTML = x;
			</script>
        </div>
    </div>
</div>
