...
<div class="form">
    ...
    if(isset($status) && !is_null($status)){
        ...
        echo Yii::t('admin', 'Any images in email templates uploaded to the media module of this instance of Upward Plus+ will be dead links as of 5.3. As a result of this, we are providing this tool to attempt to convert these links to the new format.').'<br><br>';
