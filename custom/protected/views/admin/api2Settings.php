    ...
    <div class="form">
        <div class="row">
            <p><?php echo Yii::t('admin', 'These settings configure the behavior '
                    . 'of the REST API at: {url}. For more information '
                    . 'about this API and how to use it, see {docUrl}', array(
                '{url}' => '<strong>'.CHtml::encode($this->createAbsoluteUrl('/api2')).'</strong>',
                 '{docUrl}' => CHtml::link(Yii::t('admin','The Upward Plus+ REST API Reference'),'http://wiki.x2engine.com/wiki/REST_API_Reference')
