    ...
    public function actionGet() {
        ...
        if(Yii::app()->user->isGuest) {
            ...
            echo CJSON::encode(array(
                'sessionError'=>Yii::t('app','Your Upward Plus+ session has expired. You may select "cancel" to ignore this message and recover unsaved data from the current page. Otherwise, you will be redirected to the login page.')
            ));
            Yii::app()->end();
        }
