...
class EmailDropboxSettings extends JSONEmbeddedModel {
    ...
    public function renderInputs() {
        ...
        echo X2Html::hint(Yii::t('admin', 'If disabled, the email dropbox will ignore any emails that are to or from addresses not matching any contacts in Upward Plus+. If enabled, new contacts will be created automatically using name info contained in the email.'));
        echo '<br />';
