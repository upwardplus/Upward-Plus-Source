            ...
            <div class="row">
                ...
                switch($model->type) {
                    ...
                    case "custom":
                        ...
                        echo '<br />'.Yii::t('admin','The template defines how the field will be displayed in Upward Plus+. The type defines how to interpret the template. If the type is Formula, it will be interpreted as a Workflow formula.');
                        echo '<br /><br />';
                        break;
