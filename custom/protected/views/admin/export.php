...
<div class="form">
    <?php echo Yii::t('admin', 'This page will export all data from all modules into a CSV file. This CSV can be re-imported to another Upward Plus+ installation as is without any formatting changes.') ?>
    <br><br>
    <?php
