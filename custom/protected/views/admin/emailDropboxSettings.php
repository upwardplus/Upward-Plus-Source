...
<div class="admin-form-container">
    <div class="form">
        <div class="row">
            ...
            <?php echo Yii::t('admin', 'This feature allows Upward Plus+ to receive and record emails at a special address.'); ?><br /><br />
            <?php echo Yii::t('admin', 'Before beginning, please see {emailConfig} on the Wiki.', array('{emailConfig}' => CHtml::link(Yii::t('admin', 'Email Dropbox Configuration'), 'http://wiki.x2engine.com/wiki/E-Mail_Configuration#Configuring_the_.22Email_Dropbox.22_For_Receiving_Emails'))); ?>
        </div>
        <br /><hr />
        <div class="row">
