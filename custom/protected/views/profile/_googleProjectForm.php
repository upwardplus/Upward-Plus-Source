...
echo '<br>';
echo Yii::t('admin', 'Enter property IDs to enable Google Analytics tracking. The public ID will be used on publicly-accessible web lead and service case forms. The internal one will be used within Upward Plus+, for tracking the activity of authenticated users.');
