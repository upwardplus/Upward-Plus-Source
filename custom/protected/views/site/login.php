...
<?php if(Yii::app()->settings->appName != "Upward Plus+"): ?>
        <h1 id='app-title'>
        ...
        <div class="row">
            <div class="cell form-cell" id="login-form-inputs-container">
                ...
                if ($loginLogo) {
					...
					echo '<img id="login-form-logo" src="https://upwardplus.com/common-images/loginlogo.png" alt="Upward Plus+ Login">';
                ...
                <div class="row" id='signin-button-container'>
                    <button id='up-signin-button' class='blue'>
                        <?php
                    ...
                    <!--<button class='x2-button x2-blue' 
                     ...
                     title='<?php echo CHtml::encode (Yii::t('app', 'Touchscreen Sign In')); ?>'>
                        <?php
                ...
                <div class="row login-links">
                    ...
                    <?php
                    echo CHtml::link(
                        '<img src="'.Yii::app()->theme->baseUrl.'/images/mobile.png" id="mobile-icon" /><span>'.Yii::t('app','Mobile').'</span>',
