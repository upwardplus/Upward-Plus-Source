...
if ($preselectedMap) {
    ...
    echo Yii::t('admin','Selecting "DO NOT MAP" will ignore the field from your CSV, and selecting "CREATE NEW FIELD" will generate a new text field within Upward Plus+ and map your field to it.').'<br /><br />';
}
...
<?php echo Yii::t('admin','Selecting "DO NOT MAP" will ignore the field. Selecting "CREATE NEW FIELD" will generate a new text field within Upward Plus+ and map your field to it. Selecting "APPLY TAGS" will treat the attribute as a list of tags and apply each tag to the imported record.') ?>
<br /><br />
<table id="import-map" >
    <tr>
        <td><strong><?php echo Yii::t('admin','Your Field');?></strong></td>
...
<?php
    echo X2Html::hint(Yii::t('admin', "A meaningful description of the data source will be helpful to identify the import mapping. The mapping name will "
                ." be generated in the form '{source} to Upward Plus+ {version}' to identify the data sources for which the import map was intended."), false);
