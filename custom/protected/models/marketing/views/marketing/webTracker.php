...
<div class="form">
    ...
    echo Yii::t('marketing','If you want to track {contacts} on a website with a domain that is '.
        'different from the domain on which the application is hosted, you\'ll have to configure your {link}.',
        array(
            '{link}' => CHtml::link(
...
<?php
    ...
    echo X2Html::hint (Yii::t ('marketing',
        ...
        'SSL. Please note: the code that is generated is specific to your Upward Plus+ installation.'
    ));
?>
...
<h4><b><?php echo Yii::t('marketing','Identity Settings'); ?></b></h4>
<div class="row">
    <?php
    echo Yii::t('marketing', "Identity uses browser fingerprinting as an alternative ".
