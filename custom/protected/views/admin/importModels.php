...
<?php if (!empty($model)) { ?>
    ...
    <br><br>
    <?php echo Yii::t('admin','The application will attempt to automatically map your column headers to our fields in the database.  If a match is not found, you will be given the option to choose one of our fields to map to, ignore the field, or create a new field within Upward Plus+.'); ?>
    <br><br>
