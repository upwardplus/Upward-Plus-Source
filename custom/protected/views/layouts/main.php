...
if ($isAdmin && file_exists(
    ...
    Yii::app()->user->setFlash('admin.update',Yii::t('admin', 'A new version is available: {version}',array('{version}'=>'<strong>'.Yii::app()->session['newVersion'].'</strong>'))
            .'&nbsp;&bull;&nbsp;'.CHtml::link(Yii::t('admin','Update Upward Plus+'),array('/admin/updater'))
...
if ($isAdmin && isset($expirationDate)) {
    $supportLink = CHtml::link ('Upward Plus+', 'http://www.upwardplus.com/support');
...
if(is_int(Yii::app()->locked)) {
    ...
    if(file_exists(
        ...
        $lockMsg .= ' '.CHtml::link(
            Yii::t('admin','Unlock Upward Plus+'),array('/admin/lockApp','toggle'=>0));
    } else {
...
?>
<link rel="stylesheet" type="text/css" href="/custom/upwardstyles.css?v=001">
        ...
        <div id="header-inner">
            <div id="main-menu-bar">
                ...
                if ($menuLogo && 
					...
					/* DEFAULT LOGO */
					echo '<img id="your-logo" class="default-logo" src="https://upwardplus.com/common-images/Logo_3_h30.png" alt="Upward Plus+ CRM">';
